      ...
      <div>
        <div v-show="currentState">
          ...
          <menu style="list-style: none">
            <li role="menuitem">
              <nuxt-link :to="localePath('analyzegoods')" v-html="$t('AnalyzeGoods')" />
            </li>
            <li role="menuitem">
              <nuxt-link :to="localePath('forecastbudget')" v-html="$t('ForecastBudget')" />
            </li>
            <li role="menuitem">
              <nuxt-link :to="localePath('budgetauthorities')" v-html="$t('BudgetAuthorities')" />
            </li>
            <li role="menuitem">
            ...
            <li role="menuitem">
              <div v-if="$i18n.locale == 'en'">
                <a href="https://app.csps-efpc.gc.ca/d2l/lms/quizzing/user/quiz_summary.d2l?qi=4157&ou=7881
...
" target="_top">Test</a>
          ...
          <menu style="list-style: none">
            ...
            <li role="menuitem">
              <div v-if="$i18n.locale == 'en'">
                <a href="https://app.csps-efpc.gc.ca/d2l/lms/quizzing/user/quiz_summary.d2l?qi=4158&ou=7881
...
" target="_top">Test</a>
          ...
          <menu style="list-style: none">
            ...
            <li role="menuitem">
              <div v-if="$i18n.locale == 'en'">
                <a href="https://app.csps-efpc.gc.ca/d2l/lms/quizzing/user/quiz_summary.d2l?qi=4156&ou=7881
...
" target="_top">Test</a>
          ...
          <menu style="list-style: none">
            ...
            <li role="menuitem">
              <div v-if="$i18n.locale == 'en'">
                <a href="https://app.csps-efpc.gc.ca/d2l/lms/quizzing/user/quiz_summary.d2l?qi=4159&ou=7881

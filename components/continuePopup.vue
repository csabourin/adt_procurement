<template>
  <b-modal no-stacking :id="id" okOnly>
    ...
    <b-row>
      <b-col>
        <p class="text-center review">{{ $t('content') }}</p>
      </b-col>
    </b-row>
...
<i18n>
  {
    "en":{
      "title": "Continue to next segment",
      "content": "You completed this section, continue to the next one!"
    },
    "fr":{

<template>
  <div>
    ...
    <p v-html="$t('q1.text')"></p>
    <select v-model="options1">
      <option disabled value=''>{{$t('qDisabled')}}</option>
      <option v-for="(statement,index) in answers1" value="index">{{$t(statement)}}</option>
    </select>
  </div>
</template>
<i18n>
...
export default {
  data() {
    return {
      answers1: ['q1.a11', 'q1.a12', 'q1.a13', 'q1.a14', 'q1.a15', 'q1.a16', 'q1.a17', 'q1.a18', 'q1.a19', 'q1.a110', 'a111', ],
      options1: '',
      options2: '',
      options3: '',
      options4: '',

...
<p v-html="$t('q2.text')" />
  ...
  <b-tab title="Question 3">
   <p v-html="$t('q3.text')" />
    <ol type="1">
      <li><input id="q3o1" type="radio" value="1" v-model="Quest3" name="Question3"> <label for="q3o1" v-html="$t('q3.o1')"></label></li>
      <li><input id="q3o2" type="radio" value="2" v-model="Quest3" name="Question3"> <label for="q3o2" v-html="$t('q3.o2')"></label></li>
      <li><input id="q3o3" type="radio" value="3" v-model="Quest3" name="Question3"> <label for="q3o3" v-html="$t('q3.o3')"></label></li>
    </ol>
...
<p v-html="$t('q4.text')" />
    <ol type="1">
      <li><input id="q4o1" type="radio" value="1" v-model="Quest4" name="Question4"> <label for="q4o1" v-html="$t('q4.o1')"></label></li>
      <li><input id="q4o2" type="radio" value="2" v-model="Quest4" name="Question4"> <label for="q4o2" v-html="$t('q4.o2')"></label></li>
      <li><input id="q4o3" type="radio" value="3" v-model="Quest4" name="Question4"> <label for="q4o3" v-html="$t('q4.o3')"></label></li>
      <li><input id="q4o4" type="radio" value="4" v-model="Quest4" name="Question4"> <label for="q4o4" v-html="$t('q4.o4')"></label></li>
    </ol>
  </b-tab>
  <b-tab title="Question 5">
<p v-html="$t('q5.text')" />
    <ol type="1">
      <li><input id="q5o1" type="radio" value="1" v-model="Quest5" name="Question5"> <label for="q5o1" v-html="$t('q5.o1')"></label></li>
      <li><input id="q5o2" type="radio" value="2" v-model="Quest5" name="Question5"> <label for="q5o2" v-html="$t('q5.o2')"></label></li>
      <li><input id="q5o3" type="radio" value="3" v-model="Quest5" name="Question5"> <label for="q5o3" v-html="$t('q5.o3')"></label></li>
      <li><input id="q5o4" type="radio" value="4" v-model="Quest5" name="Question5"> <label for="q5o4" v-html="$t('q5.o4')"></label></li>
    </ol>
  </b-tab>
  <b-tab title="Question 6">
<p v-html="$t('q6.text')" />
    <ol type="1">
      <li><input id="q6o1" type="radio" value="1" v-model="Quest6" name="Question6"> <label for="q6o1" v-html="$t('q6.o1')"></label></li>
      <li><input id="q6o2" type="radio" value="2" v-model="Quest6" name="Question6"> <label for="q6o2" v-html="$t('q6.o2')"></label></li>
      <li><input id="q6o3" type="radio" value="3" v-model="Quest6" name="Question6"> <label for="q6o3" v-html="$t('q6.o3')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 7">
<p v-html="$t('q7.text')" />
    <ol type="1">
      <li><input id="q7o1" type="radio" value="1" v-model="Quest7" name="Question7"> <label for="q7o1" v-html="$t('q7.o1')"></label></li>
      <li><input id="q7o2" type="radio" value="2" v-model="Quest7" name="Question7"> <label for="q7o2" v-html="$t('q7.o2')"></label></li>
      <li><input id="q7o3" type="radio" value="3" v-model="Quest7" name="Question7"> <label for="q7o3" v-html="$t('q7.o3')"></label></li>
      <li><input id="q7o4" type="radio" value="4" v-model="Quest7" name="Question7"> <label for="q7o4" v-html="$t('q7.o4')"></label></li>
      <li><input id="q7o5" type="radio" value="5" v-model="Quest7" name="Question7"> <label for="q7o5" v-html="$t('q7.o5')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 8">
<p v-html="$t('q8.text')" />
    <ol type="1">
      <li><input id="q8o1" type="radio" value="1" v-model="Quest8" name="Question8"> <label for="q8o1" v-html="$t('q8.o1')"></label></li>
      <li><input id="q8o2" type="radio" value="2" v-model="Quest8" name="Question8"> <label for="q8o2" v-html="$t('q8.o2')"></label></li>
      <li><input id="q8o3" type="radio" value="3" v-model="Quest8" name="Question8"> <label for="q8o3" v-html="$t('q8.o3')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 9">
<p v-html="$t('q9.text')" />
    <ol type="1">
      <li><input id="q9o1" type="radio" value="1" v-model="Quest9" name="Question9"> <label for="q9o1" v-html="$t('q9.o1')"></label></li>
      <li><input id="q9o2" type="radio" value="2" v-model="Quest9" name="Question9"> <label for="q9o2" v-html="$t('q9.o2')"></label></li>
      <li><input id="q9o3" type="radio" value="3" v-model="Quest9" name="Question9"> <label for="q9o3" v-html="$t('q9.o3')"></label></li>
      <li><input id="q9o4" type="radio" value="4" v-model="Quest9" name="Question9"> <label for="q9o4" v-html="$t('q9.o4')"></label></li>
      <li><input id="q9o5" type="radio" value="5" v-model="Quest9" name="Question9"> <label for="q9o5" v-html="$t('q9.o5')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 10">
<p>{{$t('q10.text')}}</p>
    <ol type="1">
      <li><input id="q10o1" type="radio" value="1" v-model="Quest10" name="Question10"> <label for="q10o1" v-html="$t('q10.o1')"></label></li>
      <li><input id="q10o2" type="radio" value="2" v-model="Quest10" name="Question10"> <label for="q10o2" v-html="$t('q10.o2')"></label></li>
      <li><input id="q10o3" type="radio" value="3" v-model="Quest10" name="Question10"> <label for="q10o3" v-html="$t('q10.o3')"></label></li>
      <li><input id="q10o4" type="radio" value="4" v-model="Quest10" name="Question10"> <label for="q10o4" v-html="$t('q10.o4')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 11">
<p>{{$t('q11.text')}}</p>
    <ol type="1">
      <li><input id="q11o1" type="radio" value="1" v-model="Quest11" name="Question11"> <label for="q11o1" v-html="$t('q11.o1')"></label></li>
      <li><input id="q11o2" type="radio" value="2" v-model="Quest11" name="Question11"> <label for="q11o2" v-html="$t('q11.o2')"></label></li>
      <li><input id="q11o3" type="radio" value="3" v-model="Quest11" name="Question11"> <label for="q11o3" v-html="$t('q11.o3')"></label></li>
      <li><input id="q11o4" type="radio" value="4" v-model="Quest11" name="Question11"> <label for="q11o4" v-html="$t('q11.o4')"></label></li>
      <li><input id="q11o5" type="radio" value="5" v-model="Quest11" name="Question11"> <label for="q11o5" v-html="$t('q11.o5')"></label></li>
    </ol>
    </b-tab><b-tab title="Question 12">
<p>{{$t('q12.text')}}</p>
    <ol type="1">
      <li><input id="q12o1" type="radio" value="1" v-model="Quest12" name="Question12"> <label for="q12o1" v-html="$t('q12.o1')"></label></li>
      <li><input id="q12o2" type="radio" value="2" v-model="Quest12" name="Question12"> <label for="q12o2" v-html="$t('q12.o2')"></label></li>
      <li><input id="q12o3" type="radio" value="3" v-model="Quest12" name="Question12"> <label for="q12o3" v-html="$t('q12.o3')"></label></li>
    </ol>
    </b-tab>
    <b-tab title="Question 13">
<p>{{$t('q13.text')}}</p>
    <ol type="1">
      <li><input id="q13o1" type="radio" value="1" v-model="Quest13" name="Question13"> <label for="q13o1" v-html="$t('q13.o1')"></label></li>
      <li><input id="q13o2" type="radio" value="2" v-model="Quest13" name="Question13"> <label for="q13o2" v-html="$t('q13.o2')"></label></li>
      <li><input id="q13o3" type="radio" value="3" v-model="Quest13" name="Question13"> <label for="q13o3" v-html="$t('q13.o3')"></label></li>
      <li><input id="q13o4" type="radio" value="4" v-model="Quest13" name="Question13"> <label for="q13o4" v-html="$t('q13.o4')"></label></li>
      <li><input id="q13o5" type="radio" value="5" v-model="Quest13" name="Question13"> <label for="q13o5" v-html="$t('q13.o5')"></label></li>
    </ol>
    </b-tab>
    <b-tab title="Question 14">
<p>{{$t('q14.text')}}</p>
    <ol type="1">
      <li><input id="q14o1" type="radio" value="1" v-model="Quest14" name="Question14"> <label for="q14o1" v-html="$t('q14.o1')"></label></li>
      <li><input id="q14o2" type="radio" value="2" v-model="Quest14" name="Question14"> <label for="q14o2" v-html="$t('q14.o2')"></label></li>
      <li><input id="q14o3" type="radio" value="3" v-model="Quest14" name="Question14"> <label for="q14o3" v-html="$t('q14.o3')"></label></li>
      <li><input id="q14o4" type="radio" value="4" v-model="Quest14" name="Question14"> <label for="q14o4" v-html="$t('q14.o4')"></label></li>
    </ol>
  </b-tab>
      </b-tabs>
    </b-card>
...
export default {
  data() {
    return {
      ...
      q3Submitted:false,
      Quest1: '',
       answers1: ['q1.a11', 'q1.a12', 'q1.a13', 'q1.a14', 'q1.a15', 'q1.a16', 'q1.a17', 'q1.a18', 'q1.a19', 'q1.a110', 'q1.a111' ],
      options1: '',
      options2: '',
      options3: '',
      options4: '',
...
<i18n>
    ...
    "en":
    {
        "qDisabled": "Please make a choice",

...
<i18n>{
    "en":
    {
        ...
        "a2-1": "<span class='v-wrong' /> While this is a great priority, our scope is more about fisheries.",
        "a2-2": "<span class='v-wrong' /> While this is a great priority, our scope is more about fisheries.",
        "a2-3": "<span class='v-right' /> <strong>This is the correct answer</strong>. Our scope is about fisheries",

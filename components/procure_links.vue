  ...
  <span>
    <div v-if="$i18n.locale=='fr'">
      <div>
        ...
        <ul class="list-unstyled">
          ...
          <li><externalLink link="https://achatsetventes.gc.ca/applications/Application-sur-les-offres-a-commande-et-arrangements-en-matiere-d-approvisionnement-appli-OCAMA">Application sur les offres à commandes et arrangements en matière d’approvisionnement</externalLink>
          ...
          <li><externalLink link="https://achatsetventes.gc.ca/politiques-et-lignes-directrices/guide-des-approvisionnements/section/1/55/10">Instruments préconcurrentiels d'achat ou instruments d'achat regroupés</externalLink></li>
    ...
    <div v-if="$i18n.locale=='en'">
      <div>
        <h4>Procure</h4>
        <ul class="list-unstyled">
          <li><externalLink link="https://buyandsell.gc.ca/">Link to buyandsell.gc.ca</externalLink></li>

    ...
    <div v-if="$i18n.locale=='fr'">
      <div>
        ...
        <ul>
          ...
          <li><a href="https://www.tbs-sct.gc.ca/ems-sgd/edb-bdd/index-fra.html#start">InfoBase du GC</a> (Trouver l'information la plus récente sur les finances, l&rsquo;effectif et les résultats du gouvernement)</li>
        </ul>
      </div>
    </div>

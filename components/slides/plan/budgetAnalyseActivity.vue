    ...
    <table dir="ltr" border="1" cellspacing="0" cellpadding="5" width="100%" class="AnalyzeBudgetTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td v-html="$t('budgetTableFill7')"></td>
          <td v-html="$t('budgetTableFill8')"></td>
          <td v-html="$t('budgetTableFill9')"></td>
          <td v-html="$t('budgetTableFill10')"></td>
          <td v-html="$t('budgetTableFill11')"></td>
        </tr>
        <tr>
          <td v-html="$t('budgetTableFill12')"></td>
          <td v-html="$t('budgetTableFill13')"></td>
          <td v-html="$t('budgetTableFill14')"></td>
          <td v-html="$t('budgetTableFill15')"></td>
        ...
        <tr class="qTable">
          ...
          <td v-html="$t('budgetTableFill21')"></td>
          <td v-html="$t('budgetTableFill22')"></td>
          <td v-html="$t('budgetTableFill23')"></td>
        </tr>
        <tr>
          <td v-html="$t('budgetTableFill24')"></td>
          <td v-html="$t('budgetTableFill25')"></td>
          <td v-html="$t('budgetTableFill26')"></td>
          <td v-html="$t('budgetTableFill27')"></td>
          <td v-html="$t('budgetTableFill28')"></td>
          <td v-html="$t('budgetTableFill29')"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td v-html="$t('budgetTableFill42')"></td>
          <td v-html="$t('budgetTableFill43')"></td>
          <td v-html="$t('budgetTableFill44')"></td>
          <td v-html="$t('budgetTableFill45')"></td>
        ...
        <tr class="qTable">
          ...
          <td v-html="$t('budgetTableFill51')"></td>
          <td v-html="$t('budgetTableFill52')"></td>
          <td v-html="$t('budgetTableFill53')"></td>
        </tr>
        <tr>
          <td v-html="$t('budgetTableFill54')"></td>
          <td v-html="$t('budgetTableFill55')"></td>
          <td v-html="$t('budgetTableFill56')"></td>
          <td v-html="$t('budgetTableFill57')"></td>
          <td v-html="$t('budgetTableFill58')"></td>
          <td v-html="$t('budgetTableFill59')"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td v-html="$t('budgetTableFill84')"></td>
          <td v-html="$t('budgetTableFill85')"></td>
          <td v-html="$t('budgetTableFill86')"></td>
          <td v-html="$t('budgetTableFill87')"></td>
          <td v-html="$t('budgetTableFill88')"></td>
...
<i18n>{
  ...
  "fr": {
    "q1": {
      "title": "Salaires",
      "introduction": "<table class='qTable finTable' border='1'> <th> <p>Salaires</p> </th> <th> <p>Budget (A)</p> </th> <th> <p>Réel (B)</p> </th> <th> <p>Variance (C=B-A)</p> </th> <th> <p>Explication de variance&nbsp;</p> </th> </tr> <tr> <td> <p>Année précédente&nbsp;</p> </td> <td> <p>460&nbsp;000&nbsp;$</p> </td> <td> <p>450&nbsp;000&nbsp;$</p> </td> <td> <p><span style='color: #ff0000;'>(10&nbsp;000&nbsp;$)</span></p> </td> <td> <p>Un employé était en congé sans solde.</p> </td> </tr> <tr> <td>&nbsp;</td> <td> <p>Budget</p> </td> <td> <p>CDA Réel&nbsp;</p> </td> <td> <p>Prévisions annuelles</p> </td> <td>&nbsp;</td> </tr> <tr> <td> <p>Année en cours à P6</p> </td> <td> <p>475&nbsp;000&nbsp;$</p> </td> <td> <p>237&nbsp;500&nbsp;$</p> </td> <td> <p>475&nbsp;000&nbsp;$</p> </td> <td>&nbsp;</td> </tr> </tbody> </table> <br> <ul> <li>Le salaire annuel d&rsquo;un employé est de 60&nbsp;000&nbsp;$ par année. Vous savez qu'il prendra sa retraite le 1er juillet de l&rsquo;année prochaine et qu'il ne sera pas remplacé.&nbsp;</li> <li>Vous prévoyez embaucher un employé occasionnel pendant 4 mois pour un coût total de 13&nbsp;333&nbsp;$.</li> </ul>",
      "text": "Quel budget proposez-vous pour l&rsquo;exercice financier suivant?",
      "options": {
      ...
      "conclusion": "<p> Votre point de départ est le budget de 475&nbsp;000&nbsp;$ de l&rsquo;année en cours. Pour l&rsquo;employé qui prend sa retraite et qui n'est pas remplacé, vous devez soustraire 9 mois (de juillet à mars) du salaire annuel de 60&nbsp;000&nbsp;$ (475&nbsp;000&nbsp;$ à 45&nbsp;000&nbsp;$ = 430&nbsp;000&nbsp;$). Comme les employés occasionnels ne font pas partie de l'organigramme,  les dépenses les concernant sont considérées comme discrétionnaires.</p><p><span>Il est important d&rsquo;analyser tout écart afin que les chiffres du budget proposé soient exacts. Pour connaître la raison d&rsquo;un écart, vous pouvez parler avec l&rsquo;ancien gestionnaire, votre administrateur ou votre directeur. Un rapport du ministère des Finances peut aussi fournir cette explication. </span></p>"
    },
    "q2": {
      "title": "License de logiciel",
      "introduction": "<p>Vous devrez estimer les coûts des nouvelles activités en fonction de vos besoins budgétaires. Si une activité a été terminée l&rsquo;année dernière, elle n&rsquo;apparaîtra pas dans le budget. Cherchez les activités annulées ou retardées, ou toute nouvelle activité qui pourrait ne pas être incluse dans votre niveau de référence, pour vous assurer que vos besoins budgétaires sont exacts.</p><p>Vous n&rsquo;aviez pas de logiciel dans le budget de l&rsquo;année dernière ou de l&rsquo;année en cours. En examinant votre plan de travail, vous savez que vous avez l'intention d&rsquo;acheter un nouveau logiciel l&rsquo;an prochain pour la délivrance des permis de pêche. Vous faites des recherches et découvrez que la licence du logiciel coûte 1&nbsp;000&nbsp;$ par an par agent (3 agents l&rsquo;utiliseront). La formation en ligne coûtera 800 $ par agent.</p>",
      "text": "Quel budget proposez-vous pour le nouveau logiciel pour l&rsquo;exercice financier suivant?",
      "conclusion": " La bonne réponse est 3&nbsp;000&nbsp;$. Le nouveau logiciel coûtera 1&nbsp;000&nbsp;$ par agent pour 3 agents (3 X 1&nbsp;000&nbsp;$ = 3&nbsp;000&nbsp;$). La formation ferait l'objet d&rsquo;un poste distinct. ",
      "options": {
        "1": "1000$",
        "2": "3000$",
        "3": "5400$"
    ...
    "q3": {
      ...
      "conclusion": "La bonne réponse est 1&nbsp;500&nbsp;$. Ce montant a été dépensé l&rsquo;an dernier et a également été prévu pour l&rsquo;année en cours; par conséquent, vous demandez un budget égal à vos habitudes de dépenses. "
    },
    "actInstructions": "Sélectionnez n&rsquo;importe quel point d&rsquo;interrogation et répondez à la question qui apparaît.",

        ...
        <table dir="ltr" border="1" cellspacing="0" cellpadding="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td headers="6 8 22" aria-live="assertive">{{salaryTotal}}</td>
              <td headers="7 8 22" aria-live="assertive">{{salarySurplusDeficit}}</td>
            </tr>
          </tbody>
          <thead>
            <tr class="heading">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td headers="6 29 92" aria-live="assertive">{{omTotal}}</td>
              <td headers="7 29 92" aria-live="assertive">{{omSurplusDeficitTotal}}</td>
            </tr>
            <tr>
...
<i18n>{
  ...
  "fr": {
    ...
    "hospitalityFeedback": "<p>Les prévisions annuelles de P6 passeront à 11 500 $. </p><ul><li>Comme rien n’indique que l’événement est annulé, cela n’a pas d’incidence sur les prévisions. Toutefois, vous devriez le signaler comme risque potentiel dans vos notes aux Finances.</li><li>Puisque la demande a été refusée, vous devrez diminuer votre prévision de 3&nbsp;500&nbsp;$ (1&nbsp;000 $ - 3&nbsp;500 $ = 11&nbsp;500 $).</li></ul>",

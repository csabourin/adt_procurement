...
<i18n>{
  ...
  "instructions":"Type the number here",
    ...
    "salaryFeedback": "<p>The P6 annual forecast will change to $423,333.</p><ul><li>An employee using their sick leave doesn’t impact the annual forecast as you still need to pay their salary.</li><li>Since your junior analyst will be gone the last six months (October to March) of the fiscal year, the P6 Annual Forecast for Salary will decrease by $20,000 ($443,333-$20,000=$423,333).You’ll also need to update your Salary Commitments in the financial system.</li></ul>",
  ...
  "instructions":"Entrez les chiffres ici",
    ...
    "salaryFeedback": "<p>&nbsp;Les prévisions annuelles de P6 passeront à 423 333 dollars.</p><ul><li>Un employé qui utilise ses congés de maladie n’a pas d’incidence sur les prévisions annuelles puisque vous devez quand m&ecirc;me payer son salaire.</li><li>&Eacute;tant donné que votre analyste subalterne sera absent au cours des six derniers mois (d’octobre à mars) de l’exercice, les prévisions salariales annuelles de P6 diminueront de 20&nbsp;000&nbsp;$ (443&nbsp;333&nbsp;$ - 20&nbsp;000&nbsp;$ = 423&nbsp;333&nbsp;$) et vous devrez également mettre à jour vos engagements salariaux dans le système financier.</li></ul>",
    ...
    "softwareFeedback": "<pLes prévisions annuelles de P6 passeront à 4 500 dollars.</p><ul><li>Les 6 premiers mois : 1&nbsp;000&nbsp;$ X 3 licences pour l’année &frac12; = 1&nbsp;500&nbsp;$. </li><li>Deuxième 6 mois : 2&nbsp;000&nbsp;$ X 3 licences pour l’année &frac12; = 3&nbsp;000&nbsp;$. </li></ul>",
    ...
    "hospitalityFeedback": "<p>Les prévisions annuelles de P6 passeront à 11 500 dollars. </p><ul><li>Comme rien n’indique que l’événement est annulé, cela n’a pas d’incidence sur les prévisions. Toutefois, vous devriez le signaler comme un risque potentiel dans vos notes à financer.</li><li>Puisque la demande a été refusée, vous devrez diminuer votre prévision de 3&nbsp;500&nbsp;$ (1&nbsp;000 $ - 3&nbsp;500 $ = 11&nbsp;500 $).</li></ul>",

...
<i18n>
  ...
  "intro":"Using the P5 Annual Forecast column as a reference, complete the P6 Annual Forecast column in the provided financial situation report.  Select a cell in the P6 Annual Forecast column and enter the correct amount based on the statement provided. Note: enter only numbers; no dollar signs, commas or spaces.",
    "q1": {
      ...
      "feedback": {
        "1": "<span class='v-wrong' /><strong>Incorrect.</strong> Your forecast doesn’t change.",
        "2": "<span class='v-right' /><strong>Correct!</strong>",
        "3": "<span class='v-wrong' /><strong>Incorrect.</strong> You cannot change the Year-To-Date Actuals in the P6 report."
      },
      "conclusion": "You must ask finance why the $3,000 doesn’t show up in the Year-To-Date Actuals since it has been more than 2 months since you approved the claims."
    },
    "q2": {
      ...
      "conclusion": "Finance will cancel the card and reissue a new card. You’ll also need to validate your expenditures to ensure there is no misuse of funds."
    }
  },
  "fr": {
  "intro":"En utilisant la colonne P5 Prévisions annuelles comme référence, remplissez la colonne P6 Prévisions annuelles dans le rapport sur la situation financière fourni. Sélectionnez une cellule de la colonne P6 Prévisions annuelles et entrez le montant exact en fonction du relevé fourni. Note : n'entrez que des chiffres ; pas de signes de dollar, de virgules ou d'espaces.",
    "q1": {
    ...
    "q2": {
      ...
      "options": {
        ...
        "3": "Récupérer 800 $ auprès de l'employé."
      },
      "feedback": {
        "1": "<span class='v-right' /><strong>Correct!</strong>",
      ...
      "conclusion": "Le service des finances annulera la carte et en émettra une nouvelle. Vous devrez également valider vos dépenses pour vous assurer qu'il n'y a pas de mauvaise utilisation des fonds."
    }
  }
}

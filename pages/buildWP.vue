            ...
            <b-card-body>
              <b-card-text>
                ...
                <span v-if="$i18n.locale=='fr'">
                  ...
                  <hr>
                  <p>&laquo; Maintenant que vous savez comment examiner, pr&eacute;parer et ajuster un plan de travail, voyons ce dont vous vous souvenez en r&eacute;pondant &agrave; ce petit quiz. &raquo;</p>
                </span>
              </b-card-text>
            </b-card-body>
          </b-collapse>

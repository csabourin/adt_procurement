    ...
    <section>
      ...
      <ul id="bar" ref="linkBar">
        <li  v-for="(item,index) in navBarTracks" :class="'chaptersLink '+ isItPlaying(index)">
          <p>{{ item }}</p><br>
          <a href="#mainPlayer" @click="seek" class="playButton" :key="index"  ><img src="~/assets/VideoIcon.svg"  alt="Play video icon"  width="48" height="48" :data-start="Math.ceil(startTime[index]+0.5)+.01" :data-end="endTime[index]"  :title="$t('playSegment') + ' - ' +navBarTracks[index]"></a>

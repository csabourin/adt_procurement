...
<i18n>
  
  {
    "en":{
      ...
      "transcriptText":"<p>Welcome! You’re in the right place if you’re a Manager looking to learn about how to make responsible use of public funds - to <strong>plan</strong>, <strong>spend</strong> and <strong>report</strong>. There are many reasons why Managers like you come to this course.</p><ul><li>As a new Manager, I am new at all things related to Financial Delegation and I need to learn everything there is to know about my financial responsibilities.</li><li>I’ve been a Manager for most of my career but I am new to government. I want to leverage my experience by connecting what I already know about finance to government.</li><li>I just came back from a parental leave and I could really use a refresher on my financial responsibilities and find out what might have changed since I left.</li><li>I’m an experienced Manager in government. As per the policy, I need to recertify every 5 years in order to be able to continue to exercise my financial delegation. I really just want to get to the test please.</li></ul><p>Whatever the reason that brought you here, you’re in charge of your learning.Think of this as &ldquo;a choose your own adventure&rdquo; kind of experience and take what you need in order to succeed. If all you need is to take the test because you’re already pretty familiar with the content, then, by all means, start with that.</p><p>If you just need an overview or a refresher, then simply review the intro sections of each phase to get the key highlights and tools.</p><p>Also, you will find nifty features on your screen - like the <strong>file section on the top right</strong>, where you can find tools and reference materials to help you on the job.</p><p>If you’re learning this for the first time, then take the time to <strong>go through the sections</strong> and <strong>do the in-depth learning activities</strong>, as well as the <strong>tools and resources</strong>. We promise it’s worth the effort and that you’ll be well prepared to take the test.</p><p>You’re probably wondering about the test, so here’s how it works.</p><p>As per Treasury Board requirements, succeeding the test for this course is mandatory before you can exercise financial deletion.</p><p>There are <strong>three parts</strong> to the test - one at the end of each phase - <strong>plan</strong>, <strong>spend</strong> and <strong>report</strong>.</p><p>The passing grade is <strong>80%, per part</strong>.</p><p>Each part should take you around <strong>15 to 20 minutes</strong>.</p><p>You may access the course materials during the test and you may challenge the test as many times as you need.</p><p>In the end, how you use this course is up to you! This course will remain accessible to you so you can come back and consult the different sections and tools when you need to on the job!</p><p>We are rooting for you to succeed because when you steward public funds well, you succeed in your career. And, perhaps even more importantly, you serve Canadians well, with transparency and accountability. And that’s the bottom line.</p>",

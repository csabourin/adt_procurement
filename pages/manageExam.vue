<template>
  <div>
    ...
    <div class="bottomNav manageSection">
      ...
      <microlearning path="managePart1" imagePath="manage1.svg" size="140" time="20" :completion="$store.state.currentPlaying.managePart1_player" :text="$t('lifeCycle')" type="video" />
      <microlearning path="manageKey"  imagePath="manage2.svg" size="140" time="5" :completion="$store.state.currentPlaying.managekey_player" :text="$t('KeyMessages')" type="video" />
      <microlearning youAreHere path="manageExam" size="140" time="10" imagePath="managetest.svg" :text="$t('Test')" :completion="parseInt($store.getters['manage/getScore'],10)" :highlighted="chosenScenario == 'justExam'" type="exam" questionNum="20" />
    </div>

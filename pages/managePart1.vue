<template>
  <div>
    ...
    <section>
      <b-row>
        <b-col>
          <videoPlayer ref="vp" enVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_7snp9f2c/flavorId/0_uduucrps/name/a.mp4" frVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_agt4e462/flavorId/0_z7j6keoz	/name/a.mp4" chapters chapterFile="ManagePart1.vtt" ccFile="ADT_Module 7_CAPTION.vtt" posterFile="spendPart1_poster.png" :restartAt="parseInt(thatPoint)" toResume="setmanage" :modalArray="modalArray" @timeupdate="updatePercent($event)"/>
        </b-col>
      </b-row>
      <b-container>
        <b-row>

<template>
  <div class="text-center">
    ...
    <b-container style="text-align: left">
      ...
      <b-row><b-col><br><hr><h3>{{$t('fileSet')}}</h3><a href="ADT_Ressources_360.pdf" download><scan360 :title="$t('scan360')"/></a></b-col></b-row>
    </b-container>
...
<i18n>
  ...
  "keyPlanBudget": "<h2>Create a Budget</h2>  <ul><li>Typically, budgets will include <strong>Operating and Maintenance</strong> (O&amp;M) and <strong>Salary </strong>costs. Some budgets may also include <strong>Capital </strong>and <strong>Grants and Contributions</strong> amounts.</li><li>Budgets are essentially the conversion of the work plans into financial terms. In other words, the<strong> budget represents how much you will spend to achieve your work plan activities</strong>.</li><li>To create your budget, you must a<strong>nalyze</strong> information, <strong>forecast</strong> your new budget requirements and <strong>submit</strong> your new budget for approval.</li></ul>",
  "fileSet":"Files in this section"
  },"fr":{
  "scan360":"Télécharger l'aperçu 360",
  "keyPlanQuote":" Une bonne planification mène à une bonne performance. ",
  "keyPlanWork":"<h2>Plan de travail</h2>  <ul>    <li>Un plan de travail est un calendrier détaillé des activités à réaliser, des ressources à consommer et des résultats à atteindre sur une période d'un an, habituellement un exercice financier pour un centre de responsabilité.<br></li>    <li>Pour ce faire, vous passez en revue les activités du plan de travail, du budget et des rapports de l'année précédente afin d'identifier les leçons apprises et ce qui doit être reporté. <br></li>    <li>Plus précisément, vous définissez et hiérarchisez le travail et les activités de votre unité, attribuez des ressources et des échéanciers à chaque activité, veillez à ce que les activités correspondent aux priorités organisationnelles et effectuez une évaluation des risques.</li></ul>",
    "keyPlanBudget": "<h2>Établir un budget</h2>    <ul><li>Les budgets sont essentiellement la conversion des plans de travail en termes financiers. En d'autres termes, le budget représente le montant que vous dépenserez pour réaliser votre plan.<br></li>    <li>Pour en créer un, vous passez en revue le budget de l'année précédente afin de déterminer quel salaire et quelles dépenses de fonctionnement et d'entretien vous conserverez, éliminerez et ajouterez.<br></li>    <li>Vous comparez le budget de l'année précédente au nouveau plan de travail, en vous assurant que toutes les dépenses liées aux activités sont couvertes. Vous prévoyez les dépenses et soumettez le nouveau budget proposé pour approbation, en y apportant des ajustements tout au long de l'année à mesure que les activités évoluent.</li></ul>",

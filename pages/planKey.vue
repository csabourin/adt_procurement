<template>
  <div class="text-center">
    ...
    <div class="bottomNav generalSection" v-if="chosenScenario == 'refresh'">
      ...
      <microlearning path="planKey" time="5" youAreHere size="140" :completion="$store.state.currentPlaying.kmPlan" imagePath="KeyMessP.svg" :text="$t('plan')" class="plan" noGrey />

<template>
  <div>
    ...
    <section>
      <b-row>
        <b-col>
          <videoPlayer ref="vp" enVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_6wqp7wux/flavorId/0_izfs6uve/name/a.mp4" frVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_eototcwd/flavorId/0_fveb23w9/name/a.mp4" chapters chapterFile="SpendPart2.vtt" ccFile="SpendPart2_captions.vtt" posterFile="spendPart2_poster.png" :restartAt="parseInt(thatPoint)" toResume="setSpendPart2" :modalArray="modalArray" @timeupdate="updatePercent($event)" />
        </b-col>
      </b-row>
      <b-container>
        <b-row>

<template>
  <div>
    ...
    <section>
      <b-row>
        <b-col>
          <videoPlayer ref="vp" enVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_6wqp7wux/flavorId/0_t5o3a07y/name/a.mp4" frVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_eototcwd/flavorId/0_2ev2eh5t/name/a.mp4" chapters chapterFile="SpendPart2.vtt" ccFile="ADT_Module 5_CAPTION.vtt" posterFile="MOD5.png" :restartAt="parseInt(thatPoint)" toResume="setSpendPart2" :modalArray="modalArray" @timeupdate="updatePercent($event)" />
        </b-col>
      </b-row>
      <b-container>
        <b-row>
                  ...
                  <b-card-body>
                    <b-card-text>
                      ...
                      <span v-if="$i18n.locale=='fr'">
                        ...
                        <p>[La moitié d’une horloge est remplie au-dessus des mots « 30 minutes ».]</p>
                        <p>[Une boîte de texte de référence de Liens externes apparaît.]</p>
                        <hr>

                        <h2>2. Préparer les documents de demande de soumissions</h2>
                        <p>Une boîte de texte indique : « 2. Préparer les documents de demande de soumissions ».]</p>
                        ...
                        <p>[Les mots « Renseignements sur les autres soumissionnaires » suivis d’un X s’affichent en dessous des deux autres énoncés.]</p>
    ...
    <div class="bottomNav spendSection">
      ...
      <microlearning youAreHere path="procurePart2"  imagePath="R-Contribute.svg" size="140" time="30" :completion="$store.state.currentPlaying.spendPart2_player" :text="$t('ExerciseFinancialAuthority')" type="video" />

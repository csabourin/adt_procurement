<template>
  <div>
    ...
    <section>
      <b-row>
        <b-col>
          <videoPlayer ref="vp" enVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_7snp9f2c/flavorId/0_u4svoygz/name/a.mp4" frVideoFile="https://video.csps-efpc.gc.ca/p/101/serveFlavor/entryId/0_agt4e462/flavorId/0_ab2rk3yj/name/a.mp4" chapters chapterFile="ReportPart1.vtt" ccFile="ADT_Module 8_CAPTION.vtt" posterFile="MOD8.png" :restartAt="parseInt(thatPoint)" toResume="setReportPart1" :modalArray="modalArray" @timeupdate="updatePercent($event)" />
        </b-col>
      </b-row>
      <b-container>
        <b-row>
                  ...
                  <b-card-body>
                    <b-card-text>
                      <span v-if="$i18n.locale=='en'">
                        ...
                        <p>[A text box reads, “2. Inappropriate Practices.” The image of a magnifying class over a page reappears.] </p>
                      ...
                      <p>[Un dessin fait de lignes blanches prend forme à côté de chaque puce. Une loupe devant une feuille, un voyant d’alarme clignotant et une liste de vérification.]</p>
                       ...
                       <p>[Une boîte de texte de référence de Liens externes apparaît.]</p>
                        ...
                        <p>[Une boîte de texte indique : « 2. Pratiques inappropriées ».]</p>

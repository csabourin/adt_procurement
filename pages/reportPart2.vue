<template>
  <div>
    ...
    <section>
      <videoPlayer ref="vp" frVideoFile="https://video.csps-efpc.gc.ca/p/101/sp/10100/serveFlavor/entryId/0_rvohbyn6/v/12/flavorId/0_7fvdx176/name/a.mp4" enVideoFile="https://video.csps-efpc.gc.ca/p/101/sp/10100/serveFlavor/entryId/0_u5d1t3f4/v/2/flavorId/0_29h6br9h/name/a.mp4" chapters chapterFile="ReportPart2.vtt" posterFile="video_poster.PNG" :restartAt="parseInt(thatPoint)" toResume="setReportPart1" :modalArray="modalArray" @timeupdate="updatePercent($event)" />

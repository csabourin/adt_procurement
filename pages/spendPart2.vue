            ...
            <b-card-body>
              <b-card-text>
                ...
                <span v-if="$i18n.locale=='fr'">
                  ...
                  <p>De mani&egrave;re générale, aucune facture ne doit &ecirc;tre payée tant que les biens n&rsquo;ait été re&ccedil;us ou que les services n'aient été rendus.</p>
                  ...
                  <ul>
                  <li>La date d'émission: on s&rsquo;assure que la facture a été émise à la date de commande ou apr&egrave;s celle-ci. Ou encore, s&rsquo;il s&rsquo;agit d&rsquo;un contrat, on doit vérifier que la facture a bel et bien été émise pendant la durée du contrat.</li>
                  ...
                  <p>Les factures doivent &ecirc;tre payées dans les 30 jours suivant la réception de la facture par le minist&egrave;re afin d'éviter les frais d&rsquo;intér&ecirc;t.</p>
                  ...
                  <p>De manière générale, aucune facture ne doit être payée tant que les biens n&rsquo;aient pas été reçus ou que les services n'aient été rendus.</p>
                  ...
                  <p>Avant d&rsquo;attester de l&rsquo;exactitude d&rsquo;une facture, le gestionnaire, habituellement avec l&rsquo;aide de son personnel administratif, vérifie l&rsquo;exactitude de la facture ou de la réclamation des éléments suivants: </p>
                  <ul>
                    <li>La date d'émission: on s&rsquo;assure que la facture a été émise à la date de commande ou après celle-ci. Ou encore, s&rsquo;il s&rsquo;agit d&rsquo;un contrat, on doit vérifier que la facture a bel et bien  été émise pendant la durée du contrat. </li>
                    <li>Les quantités: on vérifie à ce que le nombre d&rsquo;article réclamés corresponde bien aux articles commandés </li>
                    <li>Les taxes: on valide que le montant pour les taxes est exact</li>
                    <li>Le fournisseur ou le bénéficiaire : on s&rsquo;assure que l&rsquo;information est exacte et que le fournisseur ou le  bénéficiaire est admissible au paiement</li>
                    <li>Statut: on vérifie que la facture n'a pas déjà été payée</li>
                  ...
                  <p>Il se peut que vous deviez retourner au fournisseur pour faire corriger la facture avant de signer l&rsquo;article 34.</p>
                  <p>Les factures doivent être payées dans les 30 jours suivant la réception de la facture par le ministère afin d'éviter les frais d&rsquo;intérêt.</p>

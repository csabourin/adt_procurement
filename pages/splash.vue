...
#Begin {
  ...
  font-size: 25px;
  border-radius: 14px;
  box-shadow: 6px 9px 9px rgba(0, 0, 0, 0.25);
}
...
.mainHeader {
  ...
  background: transparent linear-gradient(0deg, rgba(130, 47, 47, 1) 0%, rgba(73, 27, 27, 1) 76%, rgba(65, 24, 24, 1) 100%) 0% 0% no-repeat padding-box;
}
